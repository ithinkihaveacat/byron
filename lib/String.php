...
class String {
    ...
    /**
     * Returns a string in which all non-US-ASCII characters converted to 
     * numeric entities.
     *
     * @return US-ASCII XML-encoded string
     */
    
    public function toNumericEntities()
    {
        
        // XHTML to XML entity conversion table derived from
        //
        // http://svn.wikimedia.org/svnroot/mediawiki/tags/REL1_9_3/phase3/includes/Sanitizer.php
        //
        // and which supposedly includes all HTML 4.01 entities.
        //  
        // If you need it, there's a similar map in the Wordpress source
        // at wp-includes/formatting/ent2ncr(), and an even longer list
        // of entities (include MathML entities) at: 
        // 
        ...
        return strtr($this->toHtmlEntities(), $table);
    ...
    /**
     * @deprecated Use toHtmlEntities().
     */
    
    public function toNamedEntities() 
    {
        return $this->toHtmlEntities();
    }

    /**
     * @deprecated Use fromHtmlEntities()
     */
    
    public function fromNamedEntities($output_charset = "UTF-8")
    {
        return $this->fromHtmlEntities($output_charset);
    }
    ...
    public function fromHtmlEntities($output_charset = "UTF-8")
    {
        return html_entity_decode($this->s, ENT_QUOTES, $output_charset);
    }
